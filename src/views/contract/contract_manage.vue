    ...
    <div class="app-container">
        ...
        <div class="header_con">
            <el-form :inline="true">
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="合同摸版ID" label-width="90px">
                            <el-input v-model="search_query.id" class="el_input" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="合同模板名称" label-width="100px">
                            <el-input v-model="search_query.name" class="el_input" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="需加注签章类别" label-width="110px">
        ...
        <div class="section_con">
            ...
            style="width: 100%;">
                <el-table-column label="合同摸版ID" width="110" align="center">
                    <template slot-scope="scope">
                        11345
                    </template>
                </el-table-column>
                <el-table-column label="合同模板名称" prop="author" width="150" align="center">
                    <template slot-scope="scope">
                        和信贷
                    </template>
                </el-table-column>
                <el-table-column label="合同版本号" width="120" align="center">
                    <template slot-scope="scope">
                        1.2.1
                    </template>
                </el-table-column>
                <el-table-column label="需加注签章类别" align="center">
                    <template slot-scope="scope">
                        资产方
                    </template>
                </el-table-column>
                <el-table-column label="合同模板关联标识" width="180" align="center">
                    <template slot-scope="scope">
                        -
                    </template>
                </el-table-column>
        ...
        :before-close="handleDialogClose">
            <div class="dialog_section">
                <el-form :model="create_form" :rules="rules" ref="create_form" label-width="130px">
                    <el-form-item label="合同摸版ID" prop="id" v-if="is_updata">
                        <el-input v-model="create_form.id" :disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="合同摸版名称" prop="name">
                        <el-input v-model="create_form.name"></el-input>
                    </el-form-item>
                    <el-form-item label="需加注签章类别" prop="type">
                        <el-select v-model="create_form.type" clearable>
                            <el-option v-for="item in calendarTypeOptions" :key="item.key" :label="item.display_name+'('+item.key+')'" :value="item.key" />
                        </el-select>
                    </el-form-item>
                    <el-form-item label="合同版本号" prop="version">
                        <el-input v-model="create_form.version"></el-input>
                    </el-form-item>
                    <el-form-item label="合同模板关联标识" prop="mark">
